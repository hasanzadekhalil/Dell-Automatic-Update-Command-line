...
$sourceps1 = 'https://raw.githubusercontent.com/hasanzadekhalil/Dellupdate/main/dell.ps1'
$destinationps1 = 'C:\DellUpdate\Dell.ps1'
Invoke-WebRequest -Uri $sourceps1 -OutFile $destinationps1
$sourcemsg = 'https://raw.githubusercontent.com/hasanzadekhalil/Dellupdate/main/usermsg.vbs'
$destinationmsg = 'C:\DellUpdate\usermsg.vbs'
Invoke-WebRequest -Uri $sourcemsg -OutFile $destinationmsg
$sourcebatch = 'https://raw.githubusercontent.com/hasanzadekhalil/Dellupdate/main/Dell_update.bat'
